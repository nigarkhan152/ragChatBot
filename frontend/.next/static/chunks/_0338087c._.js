...
function ChatPage() {
    ...
    const [sessionId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ChatPage.useState": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()
    }["ChatPage.useState"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            if (!user) return;
            fetch("http://localhost:8000/get_chats/".concat(user.user_id)).then({
                "ChatPage.useEffect": (res)=>res.json()
            }["ChatPage.useEffect"]).then({
                "ChatPage.useEffect": (data)=>{
                    // Optional: sort by timestamp
                    const sorted = data.sort({
                        "ChatPage.useEffect.sorted": (a, b)=>new Date(a.timestamp) - new Date(b.timestamp)
                    }["ChatPage.useEffect.sorted"]);
                    setChatHistory(sorted);
                }
            }["ChatPage.useEffect"]).catch({
                "ChatPage.useEffect": (err)=>console.error("Failed to fetch chat history", err)
            }["ChatPage.useEffect"]);
        }
    }["ChatPage.useEffect"], [
        user
    ...
    const handleSend = async ()=>{
        ...
        const botResponse = "Echo: ".concat(message);
        const chatPayload = {
...
_s(ChatPage, "b8FELq5zJeaI8n2Fqv5LJJ12MQ0=");
_c = ChatPage;
var _c;
...
//# sourceMappingURL=_0338087c._.js.map